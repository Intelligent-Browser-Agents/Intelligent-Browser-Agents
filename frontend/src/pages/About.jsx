    ...
    <div className="about-site">
      ...
      <main className="about-main">
        <section className="about-hero">
          ...
          <h1 className="about-hero-title">Browser work, handled.</h1>
        ...
        <section className="about-section about-section-story">
          ...
          <div className="about-story-layout">
            <div className="about-story-copy-block">
              <p>
                This platform is meant to reduce the need to repeat tedious digital tasks over and over. Instead of
                manually clicking through the same websites, forms, dashboards, and workflows, you can hand off the
                routine part and focus on the result you actually care about.
              </p>
              <p>
                In that sense, the experience is meant to feel familiar: if tools like ChatGPT help people turn
                natural-language questions into useful answers, Intelligent Browser Agents is meant to turn
                natural-language requests into completed work inside a browser.
              </p>
            </div>
            ...
            <aside className="about-aside">
              ...
              <p>
                The goal is not to replace the user. The goal is to remove repetition, keep the experience clear, and
                let the user stay in control of meaningful decisions.
              </p>
            </aside>
          </div>
        </section>
        ...
        <section className="about-section about-section-closing">
          ...
          <div className="about-closing-layout">
            <p>
              The experience is meant to be simple: say what you need, let the platform handle the tedious parts, and
              check in only when your judgment adds value.
            </p>
            <p>
              Over time, the value is not just speed. It is relief from repeated browser work and the feeling that a
              natural-language request can lead to real progress, not just an answer on a screen.
            </p>
          </div>
        </section>
      </main>
