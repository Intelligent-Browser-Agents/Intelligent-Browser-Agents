...
"""
This file simulates an entire sequence of agent calls WITHOUT the browser being opened
OR ANY REAL ACTIONS being taken!!!

Real work is being done on the app_prototype.py file. 
Copy/rename this file for other testing.
"""
#! === THIS IS A SIMULATION FILE === !#
